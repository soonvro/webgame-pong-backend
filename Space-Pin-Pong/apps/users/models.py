...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    picture = models.URLField(
        default="https://cdn.vectorstock.com/i/500p/93/68/rocket-glyph-icon-spaceship-isolated-vector-51249368.jpg"
    )
...
class Friend(models.Model):
    ...
    status = models.CharField(
        max_length=20, choices=[("pending", "보류 중"), ("accept", "수락"), ("reject", "거절")], default="보류 중"
    )
