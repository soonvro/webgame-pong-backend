...
from .serializers import (FriendListSerializer, FriendSerializer,
...
class FriendAcceptView(APIView):
    ...
    def post(self, request, friend_id):
        ...
        serializer = FriendSerializer(friendship, data={"status": "accept"}, partial=True).is_valid(
...
class FriendRejectView(APIView):
    ...
    def post(self, request, friend_id):
        ...
        serializer = FriendSerializer(friendship, data={"status": "reject"}, partial=True).is_valid(
            raise_exception=True
        )
